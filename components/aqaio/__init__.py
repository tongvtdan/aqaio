    ...
    cv.Schema(
        {
            ...
            cv.Optional(CONF_I2C_SDA, default=22): cv.int_,
            cv.Optional(CONF_I2C_SCL, default=23): cv.int_,
            cv.Optional(CONF_EPD_MOSI, default=18): cv.int_,
            cv.Optional(CONF_EPD_SCLK, default=19): cv.int_,
            cv.Optional(CONF_EPD_CS, default=21): cv.int_,
            cv.Optional(CONF_EPD_DC, default=2): cv.int_,
            cv.Optional(CONF_EPD_RST, default=1): cv.int_,
            cv.Optional(CONF_EPD_BUSY, default=0): cv.int_,
